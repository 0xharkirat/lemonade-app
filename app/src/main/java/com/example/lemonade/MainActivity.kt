...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == SELECT){
            ...
            lemonImage.contentDescription = "Click to select a lemon!"
            ...
            lemonImage.contentDescription = "Click to juice the lemon!"
            ...
            lemonImage.contentDescription = "Click to drink your lemonade!"
            ...
            lemonImage.contentDescription = "Click to start again!"
